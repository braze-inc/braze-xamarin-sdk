namespace Braze
{
    ...
    /*
	  Check whether adding [Model, Protocol] to this declaration is appropriate.
	  [Model, Protocol] is used to generate a C# class that implements this protocol,
	  and might be useful for protocols that consumers are supposed to implement,
	  since consumers can subclass the generated class instead of implementing
	  the generated interface. If consumers are not supposed to implement this
	  protocol, then [Model, Protocol] is redundant and will generate code that will never
	  be used.
	*/
    [Model, Protocol]
    [BaseType(typeof(NSObject))]
